                    ...
                    <svg viewBox="0 0 24 24" width="24" height="24">
                        <g>
                            ...
                            <path d="M10.119,2.969C8.213,2.902,6.425,3.61,5.085,4.95C3.744,6.291,3.04,8.079,3.103,9.985c0.009,0.271,0.231,0.483,0.499,0.483
                                ...
                                c1.143-1.143,2.681-1.733,4.294-1.69c0.294,0.038,0.507-0.207,0.516-0.483C10.611,3.208,10.395,2.977,10.119,2.969z"></path>
                        </g>
                    </svg>
                </a>
...
<svg version="1.1" id="FOLDERS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="32px"  viewBox="0 0 1800 1800" enable-background="new 0 0 1800 1800" xml:space="preserve">
<g>
	<g>
		<g>
...
function custom_woocommerce_register_form_bg() {
    ...
    <div id="company_fields" class="entity-fields" style="display: none;">
        <p class="form-row form-row-wide">
            <label for="reg_company_name"><?php _e('Име на фирма:', 'woocommerce'); ?> <span class="required">*</span></label>
            <input type="text" class="input-text" name="company_name" id="reg_company_name" value="<?php if (!empty($_POST['company_name'])) echo esc_attr($_POST['company_name']); ?>" />
        </p>
    </div>

    <p class="form-row form-row-wide" id="egn_eik_field">
        <label for="reg_egn_eik" id="egn_eik_label"><?php _e('ЕГН:', 'woocommerce'); ?> <span class="required">*</span></label>
        <input type="text" class="input-text" name="egn_eik" id="reg_egn_eik" value="<?php if (!empty($_POST['egn_eik'])) echo esc_attr($_POST['egn_eik']); ?>" />
    </p>
    
    <p class="form-row form-row-wide">
        <label for="billing_address_1"><?php _e('Адрес:', 'woocommerce'); ?> <span class="required">*</span></label>
        <input type="text" class="input-text" name="billing_address_1" id="billing_address_1" placeholder="<?php _e('ул./бул., №, бл., вх., ап.', 'woocommerce'); ?>" value="<?php if (!empty($_POST['billing_address_1'])) echo esc_attr($_POST['billing_address_1']); ?>" />
    </p>

    <p class="form-row form-row-wide">
        <label for="billing_city"><?php _e('Град:', 'woocommerce'); ?> <span class="required">*</span></label>
        <input type="text" class="input-text" name="billing_city" id="billing_city" value="<?php if (!empty($_POST['billing_city'])) echo esc_attr($_POST['billing_city']); ?>" />
    </p>

    <p class="form-row form-row-wide">
        <label for="billing_postcode"><?php _e('Пощенски код:', 'woocommerce'); ?> <span class="required">*</span></label>
        <input type="text" class="input-text" name="billing_postcode" id="billing_postcode" value="<?php if (!empty($_POST['billing_postcode'])) echo esc_attr($_POST['billing_postcode']); ?>" />
    </p>
    
    <p class="form-row form-row-wide">
        <label for="reg_phone"><?php _e('Телефон:', 'woocommerce'); ?> <span class="required">*</span></label>
        <input type="tel" class="input-text" name="phone" id="reg_phone" value="<?php if (!empty($_POST['phone'])) echo esc_attr($_POST['phone']); ?>" />
    </p>
